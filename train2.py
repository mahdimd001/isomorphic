...
def load_data_hf(traindir, valdir, args):
    ...
    dataset_hf = load_dataset(args.dataset, cache_dir=args.cache_dir)

    train_ds = dataset_hf["train"]
    val_ds = dataset_hf["validation"] if "validation" in dataset_hf else dataset_hf["test"]
    ...
    dataset = HFDataset(train_ds, train_transform)
    dataset_test = HFDataset(val_ds, val_transform)
...
def main(args):
    ...
    dataset, dataset_test, train_sampler, test_sampler = load_data_hf(train_dir, val_dir, args)
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--model", default='output/pruned/deit_0.6G.pth', type=str, help="path or name of the (pruned) model")
    parser.add_argument("--teacher-model", default="regnety_160.deit_in1k", type=str, help="path or name of the teacher model")
    ...
    parser.add_argument("--output-dir", default="output/finetuned/deit_0.6G", type=str, help="path to save outputs")
    ...
    parser.add_argument('--dataset',default="imagenet-1k",type=str, help="dataset name to load and train")
