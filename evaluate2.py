...
def parse_args():
    ...
    # Model
    parser.add_argument('--model', default='/lustre/hdd/LAS/jannesar-lab/msamani/Isomorphic-Pruning/output/pruned/deit_0.6G.pth', type=str, help='model name')
...
def main():
    ...
    train_loader, val_loader = prepare_imagenet_hf(cache_dir=args.cache_dir, train_batch_size=args.train_batch_size, val_batch_size=args.val_batch_size, use_imagenet_mean_std = not args.disable_imagenet_mean_std, val_resize=args.val_resize, interpolation=args.interpolation)
